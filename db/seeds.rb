...
dream1 = Dream.create(user_id: weston.id, description: "I was in a field of flowers.", lucidity: 3, title: "Field of Flowers", dream_date: "2023-05-21")
dream2 = Dream.create(user_id: weston.id, description: "I was in a field of scorpions aahhhh.", lucidity: 2, title: "Field of Scorps", dream_date: "2023-05-22")
dream3 = Dream.create(user_id: weston.id, description: "I was rock climbing, it was hella sweet!", lucidity: 4, title: "I Sent It!!!", dream_date: "2023-05-23")
...
dream4 = Dream.create(user_id: bobby.id, description: "I was floating in the endless cosmos.", lucidity: 5, title: "Lake of Stars", dream_date: "2023-05-21")
dream5 = Dream.create(user_id: bobby.id, description: "I was getting chased by a clown.", lucidity: 2, title: "Clowns are Whack", dream_date: "2023-05-22")
dream6 = Dream.create(user_id: bobby.id, description: "I was at an all inclusive beach-side music festival! It was glorious!", lucidity: 4, title: "Mayan Holidaze", dream_date: "2023-05-23")
